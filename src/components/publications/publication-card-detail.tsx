...
export const PublicationCardDetail = () => {
    ...
    return (<div className="sm:min-h-[30rem] md:min-h-[30rem] lg:min-h-[40.6rem] xl:min-h-[46rem] 2xl:min-h-[55rem] sm:max-h-[30rem] md:max-h-[30rem] lg:max-h-[41rem] xl:max-h-[46rem] 2xl:max-h-[55rem] w-full border border-neutral-950 bg-zinc-50">
        <div className={`${''} px-8 pt-6`}>
            ...
            <section className="flex flex-col">
                ...
                <section className="overflow-auto h-80">
